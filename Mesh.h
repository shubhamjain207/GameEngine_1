...
public:
	...
	void initVAO(Primitive* primitive) {
		...
		glGenBuffers(1, &this->VBO);
		glBindBuffer(GL_ARRAY_BUFFER, this->VBO);
		glBufferData(GL_ARRAY_BUFFER, this->noOfVertices * sizeof(Vertex), primitive->getVertices(), GL_DYNAMIC_DRAW);



		glGenBuffers(1, &this->EBO);
		glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, this->EBO);
		glBufferData(GL_ELEMENT_ARRAY_BUFFER, this->noOfIndices * sizeof(GLuint), primitive->getIndices(), GL_DYNAMIC_DRAW);
